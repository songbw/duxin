 ...
 */
@Controller
@RequestMapping("/duxin/product")
public class ProductController {

    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(ProductController.class);
    ...
    @ResponseBody
    public ResultBean pageQuery(@RequestBody ProductQueryBean queryBean) {
    ...
    @ResponseBody
    public ResultBean add(@RequestBody ProductDTO dto) {
        ResultBean resultBean = new ResultBean();
...
//        }
    ...
    @ResponseBody
    public ResultBean update(@RequestBody ProductDTO dto) {
        ResultBean resultBean = new ResultBean();

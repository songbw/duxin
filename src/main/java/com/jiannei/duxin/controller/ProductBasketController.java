 ...
 */
@Controller
@RequestMapping("/duxin/productBasket")
public class ProductBasketController {

    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(ProductBasketController.class);

    @Autowired
    private IProductBasketService service;

    @RequestMapping(value = "/page", method = RequestMethod.POST)
    @ResponseBody
    public ResultBean pageQuery(@RequestBody ProductBasketQueryBean queryBean) {
    ...
    @ResponseBody
    public ResultBean add(@RequestBody ProductBasketDTO dto) {
        ResultBean resultBean = new ResultBean();
...
//        }
    ...
    @ResponseBody
    public ResultBean update(@RequestBody ProductBasketDTO dto) {
        ResultBean resultBean = new ResultBean();

 ...
 */
@Controller
@RequestMapping("/duxin/orderProduct")
public class OrderProductController {

    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(OrderProductController.class);
    ...
    @ResponseBody
    public ResultBean pageQuery(@RequestBody OrderProductQueryBean queryBean) {
    ...
    @ResponseBody
    public ResultBean add(@RequestBody OrderProductDTO dto) {
            ResultBean resultBean = new ResultBean();
...
//        }
    ...
    @ResponseBody
    public ResultBean update(@RequestBody OrderProductDTO dto) {
            ResultBean resultBean = new ResultBean();

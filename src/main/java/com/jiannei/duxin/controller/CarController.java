 ...
 */
@Controller
@RequestMapping("/duxin/car")
public class CarController {

    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(CarController.class);
    ...
    @ResponseBody
    public ResultBean pageQuery(@RequestBody CarQueryBean queryBean) {
    ...
    @ResponseBody
    public ResultBean add(@RequestBody CarDTO dto) {
        ResultBean resultBean = new ResultBean();
...
//        }
    ...
    @ResponseBody
    public ResultBean update(@RequestBody CarDTO dto) {
        ResultBean resultBean = new ResultBean();

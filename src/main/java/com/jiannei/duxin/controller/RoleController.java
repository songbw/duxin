 ...
 */
@Controller
@RequestMapping("/duxin/role")
public class RoleController {

    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(RoleController.class);
    ...
    @ResponseBody
    public ResultBean pageQuery(@RequestBody RoleQueryBean queryBean) {
    ...
    @ResponseBody
    public ResultBean add(@RequestBody RoleDTO dto) {
        ResultBean resultBean = new ResultBean();
        if (StringUtils.isEmpty(dto.getName())) {
            resultBean.setFailMsg(SystemStatus.NAME_IS_NULL);
            return resultBean;
        }
...
//        }
    ...
    @ResponseBody
    public ResultBean update(@RequestBody RoleDTO dto) {
        ResultBean resultBean = new ResultBean();

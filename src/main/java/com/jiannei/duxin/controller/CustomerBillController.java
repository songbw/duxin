 ...
 */
@Controller
@RequestMapping("/duxin/customerBill")
public class CustomerBillController {

    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(CustomerBillController.class);

    @Autowired
    private ICustomerBillService service;

    @RequestMapping(value = "/page", method = RequestMethod.POST)
    @ResponseBody
    public ResultBean pageQuery(@RequestBody CustomerBillQueryBean queryBean) {
    ...
    @ResponseBody
    public ResultBean add(@RequestBody CustomerBillDTO dto) {
        ResultBean resultBean = new ResultBean();
...
//        }
    ...
    @ResponseBody
    public ResultBean update(@RequestBody CustomerBillDTO dto) {
        ResultBean resultBean = new ResultBean();

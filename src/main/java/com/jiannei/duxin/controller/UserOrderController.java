 ...
 */
@Controller
@RequestMapping("/duxin/userOrder")
public class UserOrderController {

    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(UserOrderController.class);
    ...
    @ResponseBody
    public ResultBean pageQuery(@RequestBody UserOrderQueryBean queryBean) {
    ...
    @ResponseBody
    public ResultBean add(@RequestBody UserOrderDTO dto) {
        ResultBean resultBean = new ResultBean();
...
//        }
    ...
    @ResponseBody
    public ResultBean update(@RequestBody UserOrderDTO dto) {
        ResultBean resultBean = new ResultBean();

 ...
 */
@Controller
@RequestMapping("/duxin/customer")
public class CustomerController {

    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(CustomerController.class);
    ...
    @ResponseBody
    public ResultBean pageQuery(@RequestBody CustomerQueryBean queryBean) {
    ...
    @ResponseBody
    public ResultBean add(@RequestBody CustomerDTO dto) {
        ResultBean resultBean = new ResultBean();
    ...
    @ResponseBody
    public ResultBean update(@RequestBody CustomerDTO dto) {
        ResultBean resultBean = new ResultBean();
    ...
    @ResponseBody
    public ResultBean updatePasswd(@RequestBody CustomerDTO dto) {
        ResultBean resultBean = new ResultBean();
        if (StringUtils.isEmpty(dto.getId())) {
            resultBean.setFailMsg(SystemStatus.ID_IS_NULL);
            return resultBean;
...
//        }
    ...
    @ResponseBody
    public ResultBean login(@RequestBody CustomerDTO dto) {
        ResultBean resultBean = new ResultBean();
        if (StringUtils.isEmpty(dto.getMobile())) {
            resultBean.setFailMsg(SystemStatus.USERNAME_IS_NULL);
            return resultBean;

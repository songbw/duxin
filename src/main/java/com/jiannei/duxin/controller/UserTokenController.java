 ...
 */
@Controller
@RequestMapping("/duxin/userToken")
public class UserTokenController {

    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(UserTokenController.class);

    @Autowired
    private IUserTokenService service;

    @RequestMapping(value = "/page", method = RequestMethod.POST)
    @ResponseBody
    public ResultBean pageQuery(@RequestBody UserTokenQueryBean queryBean) {
    ...
    @ResponseBody
    public ResultBean add(@RequestBody UserTokenDTO dto) {
        ResultBean resultBean = new ResultBean();
...
//        }
    ...
    @ResponseBody
    public ResultBean update(@RequestBody UserTokenDTO dto) {
        ResultBean resultBean = new ResultBean();
